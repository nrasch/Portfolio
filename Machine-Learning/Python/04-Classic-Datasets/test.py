...
if __name__ == '__main__':
    ...
    train = pd.read_csv( os.path.join(os.path.dirname(__file__), 'datasets', 'imdb_movie_reviews', 'labeledTrainData.tsv'), header=0, delimiter="\t", quoting=3 )
    test = pd.read_csv(os.path.join(os.path.dirname(__file__), 'datasets', 'imdb_movie_reviews', 'testData.tsv'), header=0, delimiter="\t", quoting=3 )
